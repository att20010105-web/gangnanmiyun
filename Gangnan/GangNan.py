...
# File path and order
tif_dir = r"I:\Input_data\111F"  # Replace with your raster file folder path
...
with rasterio.open(
    ...
    with rasterio.open(r"I:\Cumulative_flood _volume.tif", "w", **profile) as dst:
...
with rasterio.open(
    ...
    with rasterio.open(r"I:\Peak_flood_time.tif", "w", **profile) as dst:
